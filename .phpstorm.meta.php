    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'Illuminate\Contracts\Routing\UrlGenerator' => \Illuminate\Routing\UrlGenerator::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\Salary-ku\public\storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\Salary-ku\\public\\storage',
...
'hashing.rehash_on_login','view.paths','view.compiled','sanctum.stateful','sanctum.guard',
...
'logout','dashboard','profile.edit','profile.update','karyawan.dashboard',
'karyawan.absensi.clockin','karyawan.absensi.clockout','admin.dashboard','admin.karyawan.index','admin.karyawan.create',
'admin.karyawan.store','admin.karyawan.show','admin.karyawan.edit','admin.karyawan.update','admin.karyawan.destroy',
'admin.absensi.index','admin.absensi.create','admin.absensi.store','admin.absensi.edit','admin.absensi.update',
'admin.absensi.destroy','admin.gaji.index','admin.gaji.create','admin.gaji.calculate.store','admin.gaji.show',
'admin.gaji.edit','admin.gaji.update','admin.gaji.destroy','admin.gaji.print.slip','storage.local',);
        registerArgumentsSet('views', 
'admin.attendances.create','admin.attendances.edit','admin.attendances.index','admin.dashboard','admin.employees.create',
'admin.employees.edit','admin.employees.index','admin.employees.show','admin.salary.create','admin.salary.destroy',
'admin.salary.edit','admin.salary.index','admin.salary.show','admin.salary.slip','employee.attendances.history',
'employee.dashboard','layouts.admin','layouts.employee','layouts.partials.admin_sidebar','layouts.partials.admin_topbar',
'layouts.partials.employee_sidebar','layouts.partials.employee_topbar','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
